...
var prodBtn = document.querySelectorAll('.view__tab-btn');
var tabsInfo = document.querySelectorAll('.view__tab-info');
var _iterator = _createForOfIteratorHelper(prodBtn),
  _step;
try {
  var _loop = function _loop() {
    var item = _step.value;
    item.addEventListener('click', function () {
      var _iterator2 = _createForOfIteratorHelper(tabsInfo),
        _step2;
      try {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var myBtns = document.querySelectorAll('.view__tab-btn');
  myBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      myBtns.forEach(function (b) {
        return b.classList.remove('view__tab-btn--active');
      });
